          ...
          >
            ...
            >
              ...
              <div className="w-full h-[70%] flex items-center justify-center overflow-hidden rounded-2xl bg-white/40">
                <img
                  src={getImageUrl(hoveredClient.logo_path)}
                  className="w-full h-full object-contain transition-all duration-500 group-hover:scale-110"
                  alt={hoveredClient.client_name}
                />
              </div>
              ...
              <div className="h-[30%] flex flex-col items-center justify-center text-center">
                ...
                {hoveredClient.website && (
                  <a
                    href={hoveredClient.website}
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-sm text-blue-600 mt-1 opacity-80 group-hover:opacity-100 transition pointer-events-auto"
